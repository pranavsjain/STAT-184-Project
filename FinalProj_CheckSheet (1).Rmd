...
author: "Mahi Srivastava, Pranav Jain"
date: "April 26, 2020"
...
(A) .Rmd Line numbers where at least two different data sources are imported:  15, 16


(B) .Rmd Line numbers for inspecting data intake:  21, 25, 29, 33
...
(A) .Rmd Line number(s) for general data wrangling: 135-138


(B) .Rmd Line number(s) for a join operation: 119-121, 126-128
...
(E) .Rmd Line number(s) for use of reduction and/or transformation functions: 137, 173, 207


(F) .Rmd Line number(s) for use of user-defined functions: 99-115


(G) .Rmd Line number(s) for use of loops and/or control flow: 118-120
...
(A) .Rmd Line number(s) for use of mulitple different geoms: 144, 160, 161, 180, 195, 196, 214, 230, 231

(B) .Rmd Line number(s) for use of multiple aesthetics: 144, 160, 161, 180, 195, 196, 214, 230, 231

(C) .Rmd Line number(s) for use of layered graphics:  

(D) .Rmd Line number(s) for use of leaflet maps: 50 - 54
